...
import { CaseProgramItems } from './data';
    ...
    <>
      <div className={styles.box}>
        <hgroup className={styles.heading2}>
          <h2 className={styles.heading2Ja}>ビジネス留学プログラム</h2>
          <p className={styles.heading2En}>Business study abroad program</p>
        </hgroup>
        <div className={styles.cards}>
          {CaseProgramItems.map((item, index) => (
