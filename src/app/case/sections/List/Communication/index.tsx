...
import { caseCommunicationItems } from './data';
    ...
    <>
      <div className={styles.box}>
        <hgroup className={styles.heading2}>
          <h2 className={styles.heading2Ja}>異文化コミュニケーション</h2>
          <p className={styles.heading2En}>Cross-cultural communication</p>
        </hgroup>
        <div className={styles.cards}>
          {caseCommunicationItems.map((item, index) => (
